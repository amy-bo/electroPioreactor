...
Confirm each unit produces electrolysis numbers matching what Martin recorded on the bench during [PreTransport](PreTransportCheck-EdMSc26.md#4-wet-electrolysis).
