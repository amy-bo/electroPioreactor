...
We initially tried only acidifying the FeSO₄ and making the separate trace mineral solution in deionised water without pH adjustment, however this resulted in precipitation.  Addition of concentrated H₂SO₄ to bring the H₂SO₄ concentration to 0.1M redissolved the precipitate.  It was subsequently decided to change our trace mineral formulation protocol to dissolve the minerals in 0.2M H₂SO₄.
