...
- The actual insert set for that vial, seated at its normal depths: the two 6 mm electrode rods, the sparge tube, the efflux tube, and the three extra headspace tubes.

### Reagents

- Deionised water. Water is an acceptable stand-in for media here, as the headspace geometry is identical. There is no need to consume media.

### Method

1. Bring the vial and the deionised water to the vial's normal run temperature, and keep them there for the whole procedure.
2. Assemble the vial exactly as for a real run: seat every insert through the cap to its normal insertion depth, and charge the vial with the normal working liquid volume for that reactor type, filling to the working datum line.
...
7. Empty and dry the vial, re-assemble and re-charge it as in steps 2 to 5, and take the headspace mass again. Do this so you have three fills of the same vial. Record each fill as its own vial row.
8. Now remove the inserts, empty and dry the vial, and put the cap on. Tare the empty capped vial on the balance.
9. Fill the whole vial body with deionised water up to the underside of the cap, chasing out any bubble as before, and note the mass of water added to fill the whole body, in grams.
10. Note the water temperature, in degrees Celsius.
...
- Deionised water. Water is an acceptable stand-in for media here, as the headspace geometry is identical.

### Method

1. Bring the vial and the deionised water to the vial's normal run temperature, and keep them there for the whole procedure.
2. Assemble the vial exactly as for a real run: seat every insert through the cap to its normal insertion depth, and charge the vial with the normal working liquid volume for that reactor type, filling to the working datum line.
3. Draw a known volume of deionised water into the graduated syringe, reading at the top of the meniscus with your eye level to it to avoid parallax.
...
7. Empty and dry the vial, re-assemble and re-charge it as in steps 2 to 5, and take the headspace volume again. Do this so you have three fills of the same vial. Record each fill as its own vial row.
8. Now remove the inserts, empty and dry the vial, and put the cap on.
9. Fill the whole vial body with deionised water from the syringe, up to the underside of the cap, chasing out any bubble as before. If it takes more than one syringe-fill, refill and keep a running tally, and note the total volume delivered to fill the whole body, in millilitres.
10. Note the water temperature, in degrees Celsius.
...
Gravimetric water displacement is the reference method because mass on a laboratory balance is far more precise and repeatable than reading a meniscus, and the density of water at the working temperature is known to better than 0.1 percent, about 997.0 kg/m³ at 25 °C and 995.6 kg/m³ at 30 °C, so volume follows directly from mass divided by density. The graduated-syringe route trades that precision for needing only a syringe; a graduated syringe is typically good to about plus or minus 1 percent of full scale, tolerable here because the headspace is several millilitres, but a balance is preferable when available.
